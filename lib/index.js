...
(function() {
  var PathExp, _, async, colors, context, describe, groupby, render, renderAll, timing, unwrap, utils;
  ...
  module.exports = function(layoutPattern, outputPattern, contextEnum, globalsEnum, options, callback) {
    return renderAll(layoutPattern, null, outputPattern, contextEnum, globalsEnum, options, callback);
  };

  module.exports.renderString = function(layoutSource, outputPattern, contextEnum, globalsEnum, options, callback) {
    return renderAll(null, layoutSource, outputPattern, contextEnum, globalsEnum, options, callback);
  };

  renderAll = function(layoutPattern, layoutSource, outputPattern, contextEnum, globalsEnum, options, callback) {
