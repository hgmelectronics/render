...
(function() {
  ...
  module.exports = function(layoutTemplate, layoutSource, context, options, callback) {
    ...
    if (layoutTemplate) {
      ...
      if (!language) {
        throw new Error(unwrap("Must specify the --engine option when reading the template from a string or from stdin."));
      }
    }
    ...
    if (options.output && options.newerThan && !options.force && layout) {
      try {
